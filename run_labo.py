...
LAB_ROOT = PROJECT_ROOT / "DESIGN" / "laboratoire"
LAB_PROJECT_FILE = LAB_ROOT / "project.godot"
...
def validate_environment() -> None:
    ...
    if not LAB_PROJECT_FILE.is_file():
        raise RuntimeError(f"Laboratoire Godot introuvable : {LAB_PROJECT_FILE}")
