...
M0 à M4.5 sont validés (porte de sortie M4 franchie). Le chantier DI est clos sur son périmètre administratif (34 designs importés et validés, 17 exports FPS exclus `a_revoir`). Le jalon M5 (Quête, finale et fins de partie) est intégralement clos : M5.1 à M5.5 sont validées manuellement en jeu réel, y compris le dernier critère de M5.2 (progression pendant une vague active). Chantier en cours : intégration visuelle du kit modulaire et du zombie standard (M6.4), voir `roadmap_m6_4_integration_graphismes.md`. Prochaine étape : Phase 1 de cette roadmap (script de pose du kit structurel).
