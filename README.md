...
M0 à M4.5 sont validés (porte de sortie M4 franchie). Le chantier DI a importé et validé 34 designs dans `assets/` ; les 17 exports FPS de phase 5 restent exclus (`a_revoir`) faute de destinations et de consommateurs. DI.3 est terminée : le plan applicable n'inclut plus ces exclusions. La campagne manuelle consolidée (HUD M5.1, effets phase 8, kit modulaire, zombie) est intégralement validée. Les assets importés ne sont pas encore raccordés aux scènes de jeu ; DI.5 (intégration Godot) et DI.6 (mesure de performance réelle) restent à finaliser.
