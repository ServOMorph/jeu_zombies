...
- M5.1, M5.2 et M5.3 sont validées manuellement en jeu réel ; un critère de M5.2 (vague pendant l'interaction) reste non couvert. `tests_manuels.md` est vide.
...
- Prochaine étape : implémenter M5.4 (défense finale, compte à rebours 120 s).
