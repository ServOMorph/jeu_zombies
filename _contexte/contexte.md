...
- M5.1 (machine d'état de quête) et M5.2 (composants d'antidote, fabrication) sont implémentées et couvertes par tests automatisés ; validation manuelle de M5.2 en attente dans `tests_manuels.md`.
...
- Prochaine étape : valider manuellement M5.2, puis réaliser M5.3 (déploiement de l'antidote et terminal d'extraction).
...
- 2026-08-06 : M5.2 est implémentée (composants d'antidote, station de fabrication, progression automatique de `QuestController`) et testée automatiquement ; validation manuelle en attente.
